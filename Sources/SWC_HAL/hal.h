...
#include __MODULE_IF_HEADER(flm)
#endif
...
#include __MODULE_IF_HEADER(i3c)
#endif
...
#include __MODULE_IF_HEADER(jtm)
#endif
...
#include __MODULE_IF_HEADER(mdma)
#endif
...
#include __MODULE_IF_HEADER(psl)
#endif
...
/* DCY Logical Driver                                                                                      */
/*---------------------------------------------------------------------------------------------------------*/
#if defined DCY_MODULE_TYPE
#include __LOGICAL_IF_HEADER(dcy)
#endif

/*---------------------------------------------------------------------------------------------------------*/
/* DRBG Logical Driver                                                                                     */
/*---------------------------------------------------------------------------------------------------------*/
#if defined DRBG_MODULE_TYPE
#include __LOGICAL_IF_HEADER(drbg)
#endif
...
/* HKDF Logical Driver                                                                                     */
/*---------------------------------------------------------------------------------------------------------*/
#if defined HKDF_MODULE_TYPE
#include __LOGICAL_IF_HEADER(hkdf)
#endif
...
#include __LOGICAL_IF_HEADER(hss)
#endif
...
#include __LOGICAL_IF_HEADER(lms)
#endif
...
/* NCL Logical Driver                                                                                      */
/*---------------------------------------------------------------------------------------------------------*/
#if defined NCL_MODULE_TYPE
#include __LOGICAL_IF_HEADER(ncl)
#endif
...
/*---------------------------------------------------------------------------------------------------------*/
/* PRINTF Logical Driver                                                                                   */
/*---------------------------------------------------------------------------------------------------------*/
#if defined PRINTF_MODULE_TYPE
#include __LOGICAL_IF_HEADER(printf)
#endif
