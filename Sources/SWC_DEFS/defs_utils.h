...
/*---------------------------------------------------------------------------------------------------------*/
/*                                                                                                         */
/* Swap form Little endian byte to Big endian or vice versa                                                */
/* SWAP32_BYTE operation example:                                                                          */
/* 32bit source: 0x12345678                                                                                */
/* 32bit result: 0x78563412                                                                                */
/*                                                                                                         */
/*---------------------------------------------------------------------------------------------------------*/
#define SWAP32_BYTE(u32)                                                                                   \
            ( ((UINT32)((u32) & 0x000000FF) << 24)                                                         \
            | ((UINT32)((u32) & 0x0000FF00) <<  8)                                                         \
            | ((UINT32)((u32) & 0x00FF0000) >>  8)                                                         \
            | (((UINT32)(u32) & 0xFF000000) >> 24)                                                         \
            )
...
/*---------------------------------------------------------------------------------------------------------*/
#define SWAP64(u64)                                                                                        \
            ( ((UINT64)((u64) & 0x00000000FFFFFFFFLL) << 32)                                               \
            | (((UINT64)(u64) & 0xFFFFFFFF00000000LL) >> 32))
...
/*---------------------------------------------------------------------------------------------------------*/
#ifdef __GNUC__
    #define  LE16(u16)  __builtin_bswap16(u16)
#else
    #define LE16(u16)                                                                                      \
        (  ((UINT16)((u16) &   0xFF) << 8)                                                                 \
        |  (((UINT16)(u16) & 0xFF00) >> 8)                                                                 \
...
/*---------------------------------------------------------------------------------------------------------*/
#ifdef __GNUC__
    #define  LE32(u32)  __builtin_bswap32(u32)
#else
    #define LE32(u32)                                                                                      \
...
/* calculate LOG                                                                                           */
/*---------------------------------------------------------------------------------------------------------*/
#define LOG_1(n)                (((n) >= 2) ? 1 : 0)                                /* n <= 0x3--------*/
#define LOG_2(n)                (((n) >= 1<<2) ? (2 + LOG_1((n)>>2)) : LOG_1(n))    /* n <= 0xF--------*/
#define LOG_4(n)                (((n) >= 1<<4) ? (4 + LOG_2((n)>>4)) : LOG_2(n))    /* n <= 0xFF-------*/
#define LOG_8(n)                (((n) >= 1<<8) ? (8 + LOG_4((n)>>8)) : LOG_4(n))    /* n <= 0xFFFF-----*/
#define LOG(n)                  (((n) >= 1<<16) ? (16 + LOG_8((n)>>16)) : LOG_8(n)) /* n <= 0xFFFFFFFF-*/
...
/*---------------------------------------------------------------------------------------------------------*/
/* Convert the data mode of the number (u8) from BCD mode to binary mode                                   */
/*---------------------------------------------------------------------------------------------------------*/
#define BCD_TO_BIN(u8)          ((UINT8)(MSN(u8)*10 + LSN(u8)))
