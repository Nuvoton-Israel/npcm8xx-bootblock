...
/*
 * EnableSecureFIQ - Signal Group 0 interrupts using the FIQ signal.
 *
 * Inputs
 *  <nothing>
 *
...
/*
 * DisableeSecureFIQ - Signal Group 0 interrupts using the IRQ signal.
 *
 * Inputs
 *  <nothing>
 *
...
/*
 * SetIRQTarget - set target CPU for a given interrupt
 *
 * Inputs
 ...
 *  <nothing>
 */
void SetIRQTarget(unsigned int ID, cpu_trg target);
