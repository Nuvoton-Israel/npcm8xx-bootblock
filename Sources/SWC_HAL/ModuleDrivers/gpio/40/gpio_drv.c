...
void GPIO_Init (
    ...
    GPIO_DIR_T             gpioDir,
    GPIO_PULL_T            pullDir,
    _UNUSED_ GPIO_OTYPE_T   outType,
    _UNUSED_ BOOLEAN        vddDriven
)
{
    /*-----------------------------------------------------------------------------------------------------*/
    /* Error checking                                                                                      */
...
)
{
    ...
    /*-----------------------------------------------------------------------------------------------------*/
    REG_WRITE(GPnPU(port), pullEnMask ^ pullDirMask);
    REG_WRITE(GPnPD(port), pullEnMask ^ (~pullDirMask));
