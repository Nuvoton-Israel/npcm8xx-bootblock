...
#ifdef SHM_CAPABILITY_EXTENDED_SHM
    SHM_INT_ON_HOST_WR_WIN3_SEM         = 0x00001000,
    SHM_INT_ON_HOST_WR_WIN4_SEM         = 0x00002000,
#endif
#ifdef SHM_CAPABILITY_OFFSET
    SHM_INT_ON_HOST_RD_WIN1_CORE_OFFSET = 0x00010000,
    SHM_INT_ON_HOST_WR_WIN1_HOST_OFFSET = 0x00020000,
    SHM_INT_ON_HOST_RD_WIN2_CORE_OFFSET = 0x00040000,
    SHM_INT_ON_HOST_WR_WIN2_HOST_OFFSET = 0x00080000,
#ifdef SHM_CAPABILITY_EXTENDED_SHM
