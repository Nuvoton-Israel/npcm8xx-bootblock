...
#define ESPI_VW_SLP_MSC                 ESPI_VW_DEF(0x33, 0, ESPI_VW_MS)    // AMD SLP MSC
#define ESPI_VW_SLP_Z8                  ESPI_VW_DEF(0x33, 1, ESPI_VW_MS)    // AMD SLP Z8
#define ESPI_VW_SLP_Z9                  ESPI_VW_DEF(0x33, 2, ESPI_VW_MS)    // AMD SLP Z9
#define ESPI_VW_SLP_Z10                 ESPI_VW_DEF(0x33, 3, ESPI_VW_MS)    // AMD SLP Z10
#define ESPI_VW_CPU_TEMP_REQ            ESPI_VW_DEF(0x35, 0, ESPI_VW_SM)    // AMD CPU TEMP REQUEST
#define ESPI_VW_RTC_TIME_REQ            ESPI_VW_DEF(0x35, 1, ESPI_VW_SM)    // AMD RTC TIME REQUEST
#endif
...
#define ESPI_VW_HOST_C10                ESPI_VW_DEF(0x47, 0, ESPI_VW_MS)    // Host CPU entered C10 power down state (HOST_C10)
#ifdef ESPI_CAPABILITY_AMD
...
typedef enum
{
    ESPI_VW_GPIO_WIN_80_111 = 0,       //(default)
    ESPI_VW_GPIO_WIN_128_159,
...
/*---------------------------------------------------------------------------------------------------------*/
/* ESPI interrupt handler type                                                                             */
/*---------------------------------------------------------------------------------------------------------*/
typedef void (*ESPI_MSVW_HANDLER_T)(ESPI_VW msvw);
typedef void (*ESPI_RST_T)(void);

/*---------------------------------------------------------------------------------------------------------*/
/* ESPI interrupt types                                                                                    */
/*---------------------------------------------------------------------------------------------------------*/
#define ESPI_INTR_RISING     MIWU_RISING_EDGE
#define ESPI_INTR_FALLING    MIWU_FALLING_EDGE
#define ESPI_INTR_ANY_EDGE   MIWU_ANY_EDGE
#define ESPI_INTR_LOW        MIWU_LEVEL_LOW
#define ESPI_INTR_HIGH       MIWU_LEVEL_HIGH
#endif
...
void                ESPI_VW_Config                  (ESPI_VW_INT_WIN_SEL intWinSel, ESPI_VW_GPIO_IND_MAP gpioIndMap, BOOLEAN irqDis, BOOLEAN ignoreValid);
...
DEFS_STATUS         ESPI_VW_SetIndex                (UINT8 index, UINT value);
DEFS_STATUS         ESPI_VW_GetIndex                (UINT8 index, ESPI_VW_DIR_T dir, UINT* value);
