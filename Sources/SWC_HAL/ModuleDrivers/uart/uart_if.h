...
typedef enum
{
    // UART0 is a general UART block without modem-I/O-control connection to external signals.
    UART0_DEV = 0,
    // UART1-3 are each a general UART with modem-I/O-control connection to external signals.
    UART1_DEV = 1,
    UART2_DEV = 2,
    UART3_DEV = 3,
    // General UART modules with connection to external signals.
    UART4_DEV = 4,
    UART5_DEV = 5,
    UART6_DEV = 6,
    UART7_DEV = 7,  /* TIP */
...
/*---------------------------------------------------------------------------------------------------------*/
/* Uart redirection modes definitions. These numbers match the register field value. Do not change !       */
/* s == snoop                                                                                              */
/*---------------------------------------------------------------------------------------------------------*/
typedef enum UART_REDIRECTION_tag
{
    UART_MODE1_HSP1_SI2____HSP2_UART2__UART1_s_HSP1__UART3_s_SI2                = 0,       // 0 0 0: Mode 1 - HSP1 connected to SI2  , HSP2 connected to UART2 ,UART1 snoops HSP1, UART3 snoops SI2
    UART_MODE2_HSP1_UART1__HSP2_SI2____UART2_s_HSP2__UART3_s_SI2                = 1,       // 0 0 1: Mode 2 - HSP1 connected to UART1, HSP2 connected to SI2   ,UART2 snoops HSP2, UART3 snoops SI2
    UART_MODE3_HSP1_UART1__HSP2_UART2__UART3_SI2                                = 2,       // 0 1 0: Mode 3 - HSP1 connected to UART1, HSP2 connected to UART2 ,UART3 connected to SI2
    UART_MODE4_HSP1_SI1____HSP2_SI2____UART1_s_SI1___UART3_s_SI2__UART2_s_HSP1  = 3,       // 0 1 1: Mode 4 - HSP1 connected to SI1  , HSP2 connected to SI2   ,UART1 snoops SI1,  UART3 snoops SI2,   UART2 snoops HSP1 (default)
    UART_MODE5_HSP1_SI1____HSP2_UART2__UART1_s_HSP1__UART3_s_SI1                = 4,       // 1 0 0: Mode 5 - HSP1 connected to SI1  , HSP2 connected to UART2 ,UART1 snoops HSP1, UART3 snoops SI1
    UART_MODE6_HSP1_SI1____HSP2_SI2____UART1_s_SI1___UART3_s_SI2__UART2_s_HSP2  = 5,       // 1 0 1: Mode 6 - HSP1 connected to SI1  , HSP2 connected to SI2   ,UART1 snoops SI1,  UART3 snoops SI2,   UART2 snoops HSP2
    UART_MODE7_HSP1_SI1____HSP2_UART2__UART1_s_HSP1__UART3_SI2                  = 6,       // 1 1 0: Mode 7 - HSP1 connected to SI1  , HSP2 connected to UART2 ,UART1 snoops HSP1, UART3 connected to SI2
    UART_RESERVED                                                               = 7,       // skip uart mode configuration.
    UART_SKIP_MUX                                                               = 8        // this is a SW option to allow config of UART without touching the UART mux.
} UART_REDIRECTION_T;
...
/*                  mode - redirection mode (last setting is the one that is active)                       */
/*                  baudRate - BAUD for the UART module                                                    */
/* Side effects:                                                                                           */
/* Description:                                                                                            */
/*                  This routine performs UART initialization                                              */
/*---------------------------------------------------------------------------------------------------------*/
DEFS_STATUS UART_Init (UART_DEV_T devNum, UART_REDIRECTION_T mode, UART_BAUDRATE_T baudRate);
